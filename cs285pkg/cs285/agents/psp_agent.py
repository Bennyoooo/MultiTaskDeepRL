...
class PSPAgent(BaseAgent):
    def __init__(self, env, agent_params):
        ...
        self.period = agent_params['period']

        # actor/policy
        self.actor = PSPPolicy(self.agent_params["ac_dim"],
            self.agent_params["ob_dim"],
            self.agent_params["n_layers"],
            self.agent_params["size"], period=self.period, learning_rate=self.agent_params["learning_rate"])
